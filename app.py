...
def upload():
    ...
    return render_template('result.html', result=result, user_input=f.filename, image_base64_front=base64_img)
...
def validate_prediction():
    ...
    new_feedback = Feedback(user_input=user_input, model_output=model_output, feedback=feedback, timestamp=timestamp)
